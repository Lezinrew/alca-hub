...
class RedisRateLimiter:
    ...
    async def check_rate_limit(self, identifier: str, rule_name: str) -> RateLimitResult:
    ...
    async def _check_fixed_window(self, identifier: str, rule: RateLimitRule) -> RateLimitResult:
    ...
    async def _check_sliding_window(self, identifier: str, rule: RateLimitRule) -> RateLimitResult:
    ...
    async def _check_token_bucket(self, identifier: str, rule: RateLimitRule) -> RateLimitResult:
    ...
    async def _check_leaky_bucket(self, identifier: str, rule: RateLimitRule) -> RateLimitResult:
