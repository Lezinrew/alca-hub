...
from .security import SecurityManager, TokenBlacklist, validate_password_security, validate_email_security
...
async def register(
    ...
    if register_data.tipo == "morador":
        user_data.update({
            "apartamento": register_data.apartamento,
            "bloco": register_data.bloco
        })
    elif register_data.tipo == "prestador":
        user_data.update({
            "especialidades": register_data.especialidades or []
        })
